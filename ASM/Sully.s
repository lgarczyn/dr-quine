...
;checking if current file exists as it should
lea RDI, [rel buffer]
mov RSI, 0
call access
cmp EAX, 0

;dec counter only if it doesn't
jnz _endif
dec R12
_endif:
